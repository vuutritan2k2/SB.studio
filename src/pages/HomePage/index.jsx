  ...
  return (
    <>
      ...
      <div className='popularStory bg-[#f1f1f1] p-4 my-5 rounded-xl'>
        <div className='my-5 flex flex-nowrap justify-center gap-3 w-full overflow-x-auto'>
          <IoAdd className='w-40 xl:w-20 h-20 rounded-full p-1 border-4 border-[#3d3d3d]' />
