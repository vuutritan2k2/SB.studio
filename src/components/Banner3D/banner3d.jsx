...
export default function Banner3D() {
  ...
  return (
    <div className="">
      ...
      >
        <div className="absolute z-1 h-full w-full backdrop-blur flex items-center">
          <div className="infoTittle w-[50%]">
            <p className="font-bold text-[50px]">Welcome to Sb.Studio</p>
          </div>
          <div className="model3D w-[50%] h-full">
